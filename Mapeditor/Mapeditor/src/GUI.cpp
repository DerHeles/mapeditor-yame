	...
	m_application(application)
{
	...
	if (!m_noTileTexture.loadFromFile("resources/img/button_no_tile.png"))
		std::cerr << "GUI ctor error loading noTile texture!" << std::endl;

	if (!m_deactivatedTileTexture.loadFromFile("resources/img/tile_deactived.png"))
	...
	if (!m_frameTexture.loadFromFile("resources/img/label_current_tile.png"))
